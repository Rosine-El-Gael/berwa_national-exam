...
include 'connect.php';
$col=$_GET['demo'];
$sql= "SELECT * FROM product WHERE product_code= '$col'";
...
<body>
    ...
    <div class="container p-5">
        <form action="" method="POST" class="text-center">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="product_name" name="product_name" value="<?php echo $b ;?>">
            </div>
            <!-- <div class="mb-3">
    ...
    if (isset($_POST['btn'])) {
        ...
        $re= mysqli_query($conn,"UPdate `product` SET `Product_code`='$a',`product_name`='$b' WHERE product_code='$col'");
