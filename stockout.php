<?php
include 'connect.php';
$sql= mysqli_query($conn,"SELECT * FROM `product_out`");
...
<table border="4" class="text-light text-center">
        ...
        <tr>
            ...
            <tr class="text-primaryy">
                <th  colspan="6">What currently is out of the stock</th>
            </tr>
         ...
         <tr>
             ...
             <!-- <td><button name="edit" id="edit"><a href="edit.php?demo=<?php echo $row['product_code'];?>">EDIT</a></button>
                  <button name="delete" id="delete"><a href="delete.php?demo=<?php echo $row['product_code'];?>">DELETE</a></button></td>
     -->
